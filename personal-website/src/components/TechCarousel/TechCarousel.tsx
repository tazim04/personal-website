...
const TechCarousel = () => {
  ...
  return (
    <div className="md:w-[95%] w-full md:mx-auto overflow-hidden [mask-image:_linear-gradient(to_right,transparent_0,_black_128px,_black_calc(100%-200px),transparent_100%)]">
      <Marquee
        gradient={false}
